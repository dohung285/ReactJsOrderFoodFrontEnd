...
export const Food = () => {
    ...
    const onTemplateSelect = (e) => {
        ...
        // console.log(`typeof(e?.files)`, Object.keys(e?.files).map(k => e?.files[k]))
                ...
                <div className="card-body">
                    ...
                    <div className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-col">
                            <label htmlFor="firstname2">Tên món ăn</label>
                            <InputText id="firstname2" type="text" />
                        </div>
                        <div className="p-field p-col">
                            <label htmlFor="lastname2">Giá</label>
                    ...
                    <div className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-col">
                            <label htmlFor="firstname2">Mã nhóm</label>
                            <InputText id="firstname2" type="text" />
                        </div>
                        <div className="p-field p-col">
                            <label htmlFor="lastname2">Mã giảm giá</label>
                            <InputText id="lastname2" type="text" />
                        </div>
                    </div>
                    ...
                    <div className="p-fluid p-formgrid p-grid">
                        <div className="p-field p-col">
                            <label htmlFor="firstname2">Mô tả</label>
                            <InputText id="firstname2" type="text" />
                        </div>
                        <div className="p-field p-col">
                            <label htmlFor="lastname2">Mã ảnh</label>
                            <InputText id="lastname2" type="text" />
                        </div>
                    </div>
